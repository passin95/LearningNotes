...
- [一、基础概念](#%E4%B8%80%E3%80%81%E5%9F%BA%E7%A1%80%E6%A6%82%E5%BF%B5)
    - [URL](#url)
    - [TCP/IP](#tcpip)
    ...
    - [TCP 连接过程](#tcp-%E8%BF%9E%E6%8E%A5%E8%BF%87%E7%A8%8B)
- [二、HTTP](#%E4%BA%8C%E3%80%81http)
    ...
    - [Content-Type](#content-type)
        ...
        - [4. application/json，image/jpeg,……](#4-applicationjson%EF%BC%8Cimagejpeg%E2%80%A6%E2%80%A6)
- [三、具体应用](#%E4%B8%89%E3%80%81%E5%85%B7%E4%BD%93%E5%BA%94%E7%94%A8)
    - [Cookie](#cookie)
        - [1. 用途](#1-%E7%94%A8%E9%80%94)
        - [2. 创建过程](#2-%E5%88%9B%E5%BB%BA%E8%BF%87%E7%A8%8B)
        - [3. 分类](#3-%E5%88%86%E7%B1%BB)
        - [4. JavaScript 获取 Cookie](#4-javascript-%E8%8E%B7%E5%8F%96-cookie)
        - [5. Secure 和 HttpOnly](#5-secure-%E5%92%8C-httponly)
        - [6. Session](#6-session)
        - [7. 浏览器禁用 Cookie](#7-%E6%B5%8F%E8%A7%88%E5%99%A8%E7%A6%81%E7%94%A8-cookie)
        - [8. Cookie 与 Session 选择](#8-cookie-%E4%B8%8E-session-%E9%80%89%E6%8B%A9)
    ...
    - [Authorization](#authorization)
        - [Basic](#basic)
        - [Bearer](#bearer)
            - [OAuth2 授权流程](#oauth2-%E6%8E%88%E6%9D%83%E6%B5%81%E7%A8%8B)
            - [OAuth2 微信登陆流程](#oauth2-%E5%BE%AE%E4%BF%A1%E7%99%BB%E9%99%86%E6%B5%81%E7%A8%8B)
            - [在自家 App 中使用 Bearer token](#%E5%9C%A8%E8%87%AA%E5%AE%B6-app-%E4%B8%AD%E4%BD%BF%E7%94%A8-bearer-token)
            - [为什么引入 Authorization code](#%E4%B8%BA%E4%BB%80%E4%B9%88%E5%BC%95%E5%85%A5-authorization-code)
...
- [四、HTTPs](#%E5%9B%9B%E3%80%81https)
    ...
    - [证书](#%E8%AF%81%E4%B9%A6)
        - [证书包含的信息](#%E8%AF%81%E4%B9%A6%E5%8C%85%E5%90%AB%E7%9A%84%E4%BF%A1%E6%81%AF)
        - [证书的验证过程](#%E8%AF%81%E4%B9%A6%E7%9A%84%E9%AA%8C%E8%AF%81%E8%BF%87%E7%A8%8B)
    - [完整性保护](#%E5%AE%8C%E6%95%B4%E6%80%A7%E4%BF%9D%E6%8A%A4)
    - [HTTPs 的缺点](#https-%E7%9A%84%E7%BC%BA%E7%82%B9)
    - [HTTPs 连接建立过程](#https-%E8%BF%9E%E6%8E%A5%E5%BB%BA%E7%AB%8B%E8%BF%87%E7%A8%8B)
- [五、GET 和 POST 的区别](#%E4%BA%94%E3%80%81get-%E5%92%8C-post-%E7%9A%84%E5%8C%BA%E5%88%AB)
...
提供面向连接、可靠的数据传输服务，数据单位为报文段。对收到的数据（例如HTTP 请求报文）进行分割，并在各个报文上打上标记序号及端口号后转发给网络层。每一条 TCP 连接只能是点到点的。
...
- 检查 SSL 证书是否是由客户端 **受信任的根证书颁发机构** 颁发。
- 利用签发机构的公钥对证书签名进行一次验证。如果验证过后所得的信息和证书签名一致，则验证通过。依次再对签发机构进行验证，直至本地所信任的根签发机构,再由根签发机构对签发机构的签名进行验证后完成验证。
