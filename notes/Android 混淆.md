...
- [二、 混淆配置](#二-混淆配置)
    - [2.1 启动混淆](#21-启动混淆)
    - [2.2 自定义混淆规则](#22-自定义混淆规则)
        - [2.2.1 通配符](#221-通配符)
        - [2.2.2 输入输出选项 (Input/Output Options)](#222-输入输出选项-inputoutput-options)
        - [2.2.3 保留选项（Keep Options）](#223-保留选项keep-options)
        - [2.2.4 压缩选择（Shrinking Options）](#224-压缩选择shrinking-options)
        - [2.2.5 优化选项（Optimization Options）](#225-优化选项optimization-options)
        - [2.2.6 混淆选项（Obfuscation Options）](#226-混淆选项obfuscation-options)
            - [2.2.6.1 混淆字典](#2261-混淆字典)
        - [2.2.7 预校验选项（Preverification Options）](#227-预校验选项preverification-options)
        - [2.2.8 常规选项（General Options）](#228-常规选项general-options)
        - [2.2.9 混淆黑名单](#229-混淆黑名单)
        - [2.2.10 Android 混淆模板以及其它常用指令](#2210-android-混淆模板以及其它常用指令)
    - [2.3 多 Module 混淆](#23-多-module-混淆)
- [三、 混淆结果](#三-混淆结果)
    - [3.1 恢复混淆后错误堆栈信息](#31-恢复混淆后错误堆栈信息)
        - [3.1.1 通过 retrace 脚本工具](#311-通过-retrace-脚本工具)
        - [3.1.2 通过 retrace 命令](#312-通过-retrace-命令)
    - [3.2 反编译工具 jadx](#32-反编译工具-jadx)
